...
public class ServiceLocator {
    ...
    public static <C extends RemoteService> C getBusinessService(final Class beanClass, final Class remoteInterface) {
        ...
        try {
            ...
            jndiProps.put(Context.SECURITY_PRINCIPAL, org.moqui.util.SystemBinding.getPropOrEnv("colibri_legacy_user"));
            jndiProps.put(Context.SECURITY_CREDENTIALS, org.moqui.util.SystemBinding.getPropOrEnv("colibri_legacy_pass"));
